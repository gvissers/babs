...
/// Shift the number represented by the digits in `nr` left by `shift` bits, and add `off` to the
...
mod tests
{
    ...
    #[test]
    fn test_shl_add_assign_within_digit_binary()
    {
    ...
    #[test]
    fn test_shl_add_assign_within_digit_decimal()
    {
        ...
        let carry = shl_add_assign_within_digit(&mut n, 11, DecimalDigit(2_000));
        assert_eq!(n, [
            DecimalDigit(9_936),
            DecimalDigit(8_080),
            DecimalDigit(1_960),
